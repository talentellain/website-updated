  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <motion.button 
          whileHover={{ scale: 1.05, backgroundColor: '#AC58E9' }}
          style={{ 
          ...
          <div key={idx} style={{ borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
            ...
            >
              <h3 style={{ 
                ...
                fontWeight: 800, 
                margin: 0, 
                color: openIndex === idx ? '#AC58E9' : 'white',
                textTransform: 'uppercase',
                maxWidth: '85%',
                transition: '0.3s ease',
                lineHeight: 1.4
              ...
              <span style={{ fontSize: isMobile ? '1.2rem' : '1.2rem', color: openIndex === idx ? '#AC58E9' : 'rgba(255,255,255,0.2)', fontWeight: 300, transition: '0.3s ease' }}>
                {openIndex === idx ? '−' : '+'}
              </span>
            </button>
            <AnimatePresence>
        ...
        {(!isMobile || isExpanded) && (
          ...
          >
            ...
            <div style={{ marginTop: 'auto' }}>
              <motion.button
                whileHover={{ scale: 1.02, backgroundColor: isPopular ? '#AC58E9' : '#ffffff', color: isPopular ? '#fff' : '#000' }}
                whileTap={{ scale: 0.98 }}
                onClick={(e) => {
                  e.stopPropagation();
                  router.push('/');
            ...
            {service.subItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'rgba(172, 88, 233, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#AC58E9', marginBottom: '0.5rem' }}><Icon size={14} /></div>
